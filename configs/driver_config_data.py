...
# ===== БАЗОВЫЙ КЛАСС С ПОЛЯМИ ДАННЫХ =====
class HalDriverConfigData(BaseModel):
    """Базовая структура данных HAL драйвера (только поля)"""
    ...
    # Позиционные параметры с валидацией
    ...
    # Актуальные данные (read-only в реальности)
